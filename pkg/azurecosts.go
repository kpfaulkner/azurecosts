...
func NewAzureCost(subscriptionID string, tenantID string, clientID string, clientSecret string) AzureCost {
	a := AzureCost{}
	a.subscriptionID = subscriptionID
	a.tenantID = tenantID
	a.clientID = clientID
	a.clientSecret = clientSecret
	a.azureAuth = azureauth.NewAzureAuth(subscriptionID, tenantID, clientID, clientSecret)
...
func (ac *AzureCost) GetCostsPerRGPrefix(wantedPrefixes []string, allData []SubscriptionCosts) (map[string]float64, error) {
...
func (ac *AzureCost) FilterDataBasedOnSubscription(allData []SubscriptionCosts, subIDs []string) []SubscriptionCosts {
