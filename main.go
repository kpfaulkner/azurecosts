...
func main() {
	...
	ac := NewAzureCost(subscriptionID, tenantID, clientID, clientSecret)
	...
	azureCostsData := filterDataBasedOnSubscription(subscriptionCosts, []string{subscriptionID})

	// filter costs.... just an example
	prefixCosts, _ := getCostsPerRGPrefix([]string{"test-"}, azureCostsData)
